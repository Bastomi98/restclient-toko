...
class Barang extends RestController
{
  ...
  public function index_get()
  {
    ...
    if($id === null) {                   
      ...
      $total_page = ceil($total_data / $total_data);
      $start = ($p - 1) * $total_data;
      $list = $this->brg->get(null, $total_data, $start);
      if ($list) {
      $data = [
        'status' => true,
        'page' => $p,
  ...
  public function index_post()
  {
    $data =[
      ...
      'stok_barang'=>$this->post('stok_barang', true)
    ];
  ...
  public function index_put()
  {
    $data = [
      ...
      'stok_barang' => $this->put('stok_barang', true)
    ];
    $id = $this->put('id_barang', true);
    if ($id === null) {
